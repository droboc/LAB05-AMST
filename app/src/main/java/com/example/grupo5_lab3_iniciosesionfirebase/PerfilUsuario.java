package com.example.grupo5_lab3_iniciosesionfirebase;
...
public class PerfilUsuario extends AppCompatActivity {
    ...
    TextView txt_id, txt_name, txt_email, txt_cell;
    ImageView imv_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_cell= findViewById(R.id.txt_celular);
        imv_photo = findViewById(R.id.imv_foto);
        txt_id.setText(info_user.get("user_id"));
        txt_name.setText(info_user.get("user_name"));
        txt_email.setText(info_user.get("user_email"));
        txt_cell.setText(info_user.get("user_cell"));
    ...
    /*public void leerTweets(){
        db_reference.child("Grupo5").child("Tweets").addValueEventListener(new ValueEventListener() {
        @Override
